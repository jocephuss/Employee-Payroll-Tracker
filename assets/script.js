...
addNames = confirm('would you like to add more?');
  }
...
const getRandomEmployee = function(employeesArray) {
  ...
  console.log(`Congradulations! ${randomEmployee.firstName} ${randomEmployee.lastName}, you have been picked as the winner`);
